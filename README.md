...
7. Expand accepted artwork family-by-family while incremental CI validates each batch. **In progress: `main` now has 394/645 canonical artwork sources. Actions/UI, Places/Folders, Status/Panel/Waybar, Devices, and MIME/Filetypes are complete; Categories/Misc is next at W3-611.**
