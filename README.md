...
Kitty has now also been reconstructed as a real vector candidate with the corrected facet-seam overlap. Project-owner review of Dolphin and Kitty establishes the same medallion-pattern result: SVG is preferred through 128 px, PNG is preferred at 512 px, and 256 px remains genuinely borderline. This is valid evidence for the two medallion candidates but is not enough to establish a class-wide Hero rule; a materially different non-medallion control is still required.
