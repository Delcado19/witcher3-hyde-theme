...
The first Stage-E pass is observational. It fails only on malformed source data
or a real Arch desktop ID being assigned to more than one Witcher3 design.
"""
...
def main() -> int:
    ...
    for repo in ("core", "extra", "multilib"):
        count = sum(repo in repos for repos in arch_ids.values())
